...
erDiagram
    ...
    BABY_CHAT_MESSAGES {
        int id PK
        int user_id FK
        int ai_children_id FK
        string ai_message_type
        string content
        string conversation_session_id
        datetime created_at
    }
    ...
    %% Relationships
    USERS ||--o{ COUPLES : as_user1
    USERS ||--o{ COUPLES : as_user2
    COUPLES ||--o{ AI_CHILDREN : has
    USERS ||--o{ BABY_CHAT_MESSAGES : writes
    AI_CHILDREN ||--o{ BABY_CHAT_MESSAGES : in_thread
    COUPLES ||--o{ BABY_LETTERS : has
    USERS ||--o{ BABY_LETTERS : sends
    AI_CHILDREN ||--o{ BABY_LETTERS : about
    COUPLES ||--o{ VIDEO_CALLS : has
    USERS ||--o{ VIDEO_CALLS : initiates
    COUPLES ||--o{ MEDIA_FILES : has
    USERS ||--o{ MEDIA_FILES : uploads
    COUPLES ||--o{ COMIC_STRIPS : has
    COUPLES ||--o{ NICKNAMES : has
    USERS ||--o{ NICKNAMES : creates
    COUPLES ||--o{ DAILY_SCHEDULES : has
    USERS ||--o{ DAILY_SCHEDULES : creates
    COUPLES ||--o{ CHAT : contains
    USERS ||--o{ CHAT : sends
```
