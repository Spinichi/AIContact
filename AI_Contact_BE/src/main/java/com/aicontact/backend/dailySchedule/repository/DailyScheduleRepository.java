...
public interface DailyScheduleRepository extends JpaRepository<DailyScheduleEntity, Long> {
    ...
    List<DailyScheduleEntity> findByCoupleAndScheduleDate(CoupleEntity couple, LocalDate scheduleDate);

    List<DailyScheduleEntity> findByCoupleAndScheduleDateBetweenOrderByScheduleDateAsc(CoupleEntity couple, LocalDate start, LocalDate end);
}
